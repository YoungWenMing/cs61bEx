...
public class TestRasterer {
    ...
    public void testGetMapRaster() throws Exception {
        ...
        for (int i = 0; i < NUM_TESTS; i++) {
            ...
            Map<String, Double> params = testParams.get(i +1);
            Map<String, Object> actual = rasterer.getMapRaster(params);
            Map<String, Object> expected = expectedResults.get(i +1);
...
/*
modified by Young Wenming

Sept 5th, 2018, fixed a bug in startTileSpecify(), there is something wrong with formula to
generate start tiles, incorrect order of items for calculation
 */